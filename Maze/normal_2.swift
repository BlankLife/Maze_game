...
class normal_2: SKScene,SKPhysicsContactDelegate{
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        ...
        if body1.categoryBitMask == 1 && body2.categoryBitMask == 4 ||
            ...
            let nextScene = levelEnd_0(fileNamed: "levelEndScene")
            nextScene?.scaleMode = .aspectFill
            view!.presentScene(nextScene!, transition: SKTransition.doorsOpenVertical(withDuration: TimeInterval(0.01)))
        }
